...
import com.crashExams365.physics.databinding.TestFragmentBinding
import java.io.File
...
import com.crashExams365.physics.Fragments.TopicsInChap.TopicsInChapClicked
import com.crashExams365.physics.Fragments.TopicsInChap.TopicsInChapDirections
    ...
    fun doPreCal(){
        try {
            ...
            val dataObjectStore=DataObjectStore(testType,chaptername!!,hashmapForAns,hashmapForMarked
                ,true,null,marks,
                com.crashExams365.physics.CommonData.userInfo!!.firstname,
                com.crashExams365.physics.CommonData.userInfo!!.lastName)
